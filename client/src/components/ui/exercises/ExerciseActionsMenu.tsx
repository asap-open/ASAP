...
function ExerciseActionsMenu({
  ...
  return (
    <div
      className="absolute right-0 top-12 w-48 bg-white rounded-xl shadow-xl border border-slate-100 z-10 overflow-hidden animate-in fade-in zoom-in-95 duration-200"
      onClick={(e) => e.stopPropagation()}
    >
      <div className="py-1">
        <button
          onClick={onView}
          className="w-full text-left px-4 py-3 text-sm font-medium text-text-main hover:bg-slate-50 flex items-center gap-3 transition-colors"
        >
